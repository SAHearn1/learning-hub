...
export const POST = withApiHandler(async (req) => {
  ...
  if (!studentId || !sessionId || !topicName || !learningObjectives) {
    throw new ValidationError('Missing required fields: studentId, sessionId, topicName, learningObjectives');
  }
...
export const GET = withApiHandler(async (req) => {
  ...
  if (!studentId && !sessionId && !topicId) {
    throw new ValidationError('studentId, sessionId, or topicId is required');
  }
